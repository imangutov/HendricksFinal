...
function [all_etfs, indices, etf_data_set] = load_etf(begining_index)
  ...
  files = {'etf_bond_agg_ishares_core_us_aggregate_bond_monthly.xls' ...
           ...
           'etf_rom_proshares_ultra_technology_monthly.xls' ... %           'etf_rwj_revenueshares_small_cap_monthly.xls' ...
           ...
           'etf_ure_proshares_ultra_real_estate_monthly.xls' ,           'etf_uso_united_states_oil_monthly.xls' ...
           'etf_uxi_proshares_ultra_industrials_monthly.xls' ,           'etf_uyg_proshares_ultra_financials_monthly.xls' ...
...
means = zeros(size(etfs,2),1);
  ...
  for etf_index = 1:size(etfs,2)
    ...
    means(etf_index,1) = mean(returns);
  ...
  all_etfs = horzcat(timestamp_array,...
                    ...
                    get_intersect_array(timestamp_array,etfs{1,28})); %,...get_intersect_array(timestamp_array,etfs{1,29}));
